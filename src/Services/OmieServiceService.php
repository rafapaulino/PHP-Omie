...
namespace Rafapaulino\Omiephpsdk\Services;
...
final class OmieServiceService implements ServiceServiceInterface
{
    ...
    public function listServices(array $filters = []): array
    {
        ...
        $response = $this->httpClient->request('POST', 'servicos/servico/', [
            'headers' => [
