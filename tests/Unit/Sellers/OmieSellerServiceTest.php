...
it('lists sellers using ListarUsuarios payload with merged filters', function (): void {
    ...
    $result = $service->listSellers($filters);
...
it('throws when Omie credentials are missing for sellers service', function (): void {
    ...
    $call = fn (): array => $service->listSellers();
